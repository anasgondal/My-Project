                    ...
                    <div className="row">
                        <div className="col-4">
                            ...
                            <div className={cx({ "tabs": true, "tabs tabsActive": this.state.activeTab === 1 })} onClick={() => this.onClickBottomBar(1)}>
                                <p className="poppins_medium TabsHeading">Grant Details</p>
                        ...
                        <div className="col-4">
                            <div className={cx({ "tabs": true, "tabs tabsActive": this.state.activeTab === 2 })} onClick={() => this.onClickBottomBar(2)}>
                                <p className="poppins_medium TabsHeading">Grant Audience & Eligibility</p>
                                <p className="mb-0"><img src={progressMark} /> <label className="poppins_light TabsText ml-2 mb-0">In Progress...</label></p>
                        ...
                        <div className="col-4">
                            <div className={cx({ "tabs": true, "tabs tabsActive": this.state.activeTab === 3 })} onClick={() => this.onClickBottomBar(3)}>
                                <p className="poppins_medium TabsHeading">Grant Details</p>
                                <p className="mb-0"><img src={progressMark} /> <label className="poppins_light TabsText ml-2 mb-0">In Progress...</label></p>
                            </div>
                        </div>
                        ...
                        <div className="col-md-12">
                            <div className="row">
                                <div className="col-md-7">
                                    <p className="poppins_medium mb-0 GrantInfoHeading">Grant Information</p>
                                    <p className="poppins_light mb-0  GrantInfoText">Please enter grant information as per requirements</p>
                                    <div className="row mt-5">
                                        <div className="col-4 vertical_center text-right">
                                            <p className="poppins_medium GrantInfoInputText mb-0">Grant Name</p>
                                        </div>
                                        <div className="col-8">
                                    ...
                                    <div className="row mt-3">
                                        <div className="col-4 vertical_center text-right">
                                            <p className="poppins_medium GrantInfoInputText mb-0">Grant by (Optional)</p>
                                        </div>
                                        <div className="col-8">
                                            <input className="GrantInfoInput"></input>
                                        </div>
                        ...
                        <div className="col-md-12">
                            <div className="row">
                                <div className="col-md-6">
                                    ...
                                    <div className="row mt-5">
                                        <div className="col-4 vertical_center text-right">
                                            <p className="poppins_medium GrantInfoInputText mb-0">Grant Target</p>
                                        </div>
                                        <div className="col-8">
                                            <input className="GrantInfoInput"></input>
                                        </div>
                                    ...
                                    <div className="row mt-3">
                                        <div className="col-4 vertical_center text-right">
                                            <p className="poppins_medium GrantInfoInputText mb-0">Total Pool</p>
                                        </div>
                                        <div className="col-5">
                                            <input className="GrantInfoInput"></input>
                                        </div>
                                        <div className="col-3 vertical_center ">
                                            <p className="poppins_light GrantInfoInputText mb-0">No. of Person</p>
                                        </div>

                                    </div>
                                    <div className="row mt-3">
                                        <div className="col-4 vertical_center text-right">
                                            <p className="poppins_medium GrantInfoInputText mb-0">Per Person Amount
                                                Limit</p>
                                        </div>
                                        <div className="col-8">
                                            <input className="GrantInfoInput"></input>
                                    ...
                                    <div className="row mt-3">
                                        <div className="col-4 vertical_center text-right">
                                            <p className="poppins_medium GrantInfoInputText mb-0">Grant For</p>
                                        </div>
                                        <div className="col-8">
                                            <input className="GrantInfoInput"></input>
                                        </div>
                                ...
                                <div className="col-md-6">
                                    <p className="poppins_medium mb-0 GrantInfoHeading">Grant Eligibility</p>
                                    <p className="poppins_light mb-0  GrantInfoText">Please enter grant disbursement targeted audience.</p>
                                </div>

                            </div>
                            <div className="col-12  text-right">
                                <button className="Nextbtn ">Next & Continue</button>
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateGrants);
